...
def tsv_to_weighted_doc(dataset_file_path,
    ...
    with open(dataset_file_path) as dataset_file, open(prediction_file_path) as prediction_file, open(output_file_path, 'w') as output_file:
        ...
        for l1, l2 in zip(dataset_file, prediction_file):
            ...
            # with open("/home/abbas/DeepCT3/predictions2/marco/collection_25_0_00_pred_pos_max9_e6/test_results_terms2.tsv", 'w') as output_file2:
            #     output_file2.write(selected_tokens)
            # with open('/home/abbas/DeepCT3/predictions2/marco/collection_25_0_00_pred_pos_max9_e6/test_results_terms2.json', 'w') as json_file:
            #     json.dump(selected_tokens, json_file)
